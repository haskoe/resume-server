...
function createRequestListener(themes, defaultTheme) {
...
export default function Serve({ host, port, themes, defaultTheme }) {
    const server = http.createServer(createRequestListener(themes, defaultTheme));
