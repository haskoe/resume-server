...
export default function Resume(resume) { // , css) {
  return html`<!DOCTYPE html>
    <html lang="en">
      ...
      <body>
        ${Header(resume)}
        ${Simple(resume.locale.about,resume.resumeJson.basics.about)}
        ${Simple(resume.locale.motivation,resume.resumeJson.basics.motivation)}
        ${Simple(resume.locale.status,resume.resumeJson.basics.status)}
        ${Work(resume)}
        ${Volunteer(resume)}
        ${Education(resume)}
        ${Projects(resume)}
